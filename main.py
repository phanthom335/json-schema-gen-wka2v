        """
        Json Schema Gen Wka2v
        =====================
        Lightweight ETL component that can export millions of rows efficiently.
...
from pathlib import Path
        ...
        APP_NAME    = "Json Schema Gen Wka2v"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight ETL component that can export millions of rows efficiently.")
